        ...
        <div className="box">
            <div className="pin_height">
                ...
                {state==='start' && <div className="start_list">
                    <div>
                        <button onClick={pickStart} value='정문'>정문</button>
                        <button onClick={pickStart} value='한누리관'>한누리관</button>
                        <button onClick={pickStart} value='기숙사'>기숙사</button>
                    </div>
                    <div>
                        <button onClick={pickStart} value='안서 동보'>안서 동보</button>
                        <button onClick={pickStart} value='디대'>디대</button>
                        <button onClick={pickStart} value='굴다리'>굴다리</button>
                    </div>
                </div> }
                <div></div>
                ...
                { state === 'dst' && <div className="start_list">
                    <button onClick={pickDst} value='두정역'>두정역</button>
                    <button onClick={pickDst} value='천안역'>천안역</button>
                    <button onClick={pickDst} value='터미널'>터미널</button>
                </div> }
            </div>
